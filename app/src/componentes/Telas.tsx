...
function Conta() {
  ...
  return <details>
    <summary>☁️ Entrar na conta (salvar as rotas)</summary>
    ...
    <div className="linha"><button className="btn pri" onClick={() => A.entrar(email.trim(), senha)}>Entrar</button></div>
    <div className="info">A conta é criada pelo responsável. Sem entrar, o app funciona só neste celular.</div>
  </details>;
}
