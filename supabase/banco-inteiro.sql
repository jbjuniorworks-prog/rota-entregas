...
create index if not exists if not exists ruas_chave2 on public.ruas (nome_chave2) where nome_chave2 is not null;
...
create index if not exists if not exists ruas_bairro on public.ruas (bairro) where bairro is not null;
...
create index if not exists if not exists ruas_conjunto on public.ruas (conjunto) where conjunto is not null;
